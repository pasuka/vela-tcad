...
This directory contains the complete reference_tcad validation chain for a
...
The checked-in dataset is intentionally small and trend oriented. It is used to
verify signs, trends, and key orders of magnitude, not calibration.

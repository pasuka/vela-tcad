...
; Genius examples/BJT/step1.inp geometry, in micrometers.
(define silicon
...
; Split the top edge at the exact Genius contact endpoints.
...
; General analytical profiles reproduce Genius exactly. For each coordinate,
; d=(u+abs(u))/2 with u=abs(q-mid)-half is the distance outside the window.
; The placement reference window is required syntactically but General
; profiles are evaluated in device coordinates.
...
; Global mesh plus focused emitter/base and collector-junction refinement.

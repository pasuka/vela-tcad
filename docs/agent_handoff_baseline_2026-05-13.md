...
### 4.1 C++ 单元测试目标（Catch2）
注册于 [CMakeLists.txt](../CMakeLists.txt#L161) 到 [CMakeLists.txt](../CMakeLists.txt#L172)。
...
证据：[CMakeLists.txt](../CMakeLists.txt#L94), [tests/python/test_python_api.py](../tests/python/test_python_api.py#L69)
...
### 5.1 建议直接提供的上下文
1. 本文档：[docs/agent_handoff_baseline_2026-05-13.md](agent_handoff_baseline_2026-05-13.md)

param(
    ...
    [string]$OutputSummary = "build/pn2d_recomb_gate/vela/pn2d_bv_ct_refine6_summary.csv",
    [int]$SecondsPerCase = 90
)

$ErrorActionPreference = "Stop"

$cases = @(
    @{ name = "refine_mu0p85_nr1p0_a0p9"; muScale = 0.85; nrefScale = 1.0; alphaScale = 0.9 },
    @{ name = "refine_mu0p95_nr1p0_a0p9"; muScale = 0.95; nrefScale = 1.0; alphaScale = 0.9 },
    @{ name = "refine_mu0p9_nr0p9_a0p9";  muScale = 0.9;  nrefScale = 0.9; alphaScale = 0.9 },
    @{ name = "refine_mu0p9_nr1p1_a0p9";  muScale = 0.9;  nrefScale = 1.1; alphaScale = 0.9 },
    @{ name = "refine_mu0p9_nr1p0_a0p85"; muScale = 0.9;  nrefScale = 1.0; alphaScale = 0.85 },
    @{ name = "refine_mu0p9_nr1p0_a0p95"; muScale = 0.9;  nrefScale = 1.0; alphaScale = 0.95 }
)
